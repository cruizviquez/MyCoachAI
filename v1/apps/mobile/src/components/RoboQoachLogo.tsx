...
export const RoboQoachLogo = ({ size = 40 }) => (
  <Svg width={size} height={size} viewBox="0 0 100 100" fill="none">
    <Circle cx="50" cy="50" r="40" fill="none" stroke="#00D4FF" strokeWidth={3} />
    <Circle cx="50" cy="50" r="28" fill="none" stroke="#00D4FF" strokeWidth={2} opacity={0.7} />
    <Circle cx="50" cy="50" r="16" fill="none" stroke="#00D4FF" strokeWidth={2} opacity={0.5} />

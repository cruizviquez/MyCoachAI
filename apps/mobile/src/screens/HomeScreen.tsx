...
const styles = StyleSheet.create({
  ...
  exerciseCard: { flexDirection: 'row', backgroundColor: '#fff', borderRadius: 12, padding: 20, marginBottom: 15, shadowColor: '#000', shadowOffset: { width: 0, height: 2 }, shadowOpacity: 0.1, shadowRadius: 4, elevation: 3 },
  emoji: { fontSize: 40, marginRight: 15 },
  exerciseInfo: { flex: 1, justifyContent: 'center' },
  exerciseName: { fontSize: 20, fontWeight: '600', color: '#333', marginBottom: 4 },
  exerciseDescription: { fontSize: 14, color: '#666' },
});